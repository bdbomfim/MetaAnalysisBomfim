##Randon Forest analysis for meta-analysis of forest resistance to cyclone disturbance
...
#Run metaforest model with 5000 trees
...
#### Figure 4a Relative importance of predictors - Resistance of Total Litterfall####
